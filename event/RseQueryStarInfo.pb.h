...
class RseQueryStarInfo : public ::google::protobuf::Message {
 public:
  ...
  static const int kSpaceStarInfoFieldNumber = 2;
...
inline ::google::protobuf::int32 SpaceStarInfo::xp() const {
  return xp_;
}
inline void SpaceStarInfo::set_xp(::google::protobuf::int32 value) {
  _set_bit(2);
  xp_ = value;
}
...
inline ::google::protobuf::int32 SpaceStarInfo::damageprotectiontimeleft() const {
  return damageprotectiontimeleft_;
}
inline void SpaceStarInfo::set_damageprotectiontimeleft(::google::protobuf::int32 value) {
  _set_bit(9);
...
inline ::google::protobuf::int32 SpaceStarInfo::tutorialcompleted() const {
  return tutorialcompleted_;
}
inline void SpaceStarInfo::set_tutorialcompleted(::google::protobuf::int32 value) {
  _set_bit(10);
...
inline const ::std::string& SpaceStarInfo::accountid() const {
  return *accountid_;
}
inline void SpaceStarInfo::set_accountid(const ::std::string& value) {
  _set_bit(12);
  if (accountid_ == &_default_accountid_) {
...
inline void SpaceStarInfo::set_accountid(const char* value) {
  _set_bit(12);
  if (accountid_ == &_default_accountid_) {
    accountid_ = new ::std::string;
  }
...
inline void SpaceStarInfo::set_accountid(const char* value, size_t size) {
  _set_bit(12);
  if (accountid_ == &_default_accountid_) {
    accountid_ = new ::std::string;
  }
...
inline ::std::string* SpaceStarInfo::mutable_accountid() {
  _set_bit(12);
  if (accountid_ == &_default_accountid_) {
    accountid_ = new ::std::string;
  }
...
// optional int32 ret = 1;
inline bool RseQueryStarInfo::has_ret() const {
  return _has_bit(0);
}
inline void RseQueryStarInfo::clear_ret() {
  ret_ = 0;
  _clear_bit(0);
}
inline ::google::protobuf::int32 RseQueryStarInfo::ret() const {
  return ret_;
}
inline void RseQueryStarInfo::set_ret(::google::protobuf::int32 value) {
  _set_bit(0);
  ret_ = value;
}
...
// optional int32 name = 6;
inline bool RseQueryStarInfo::has_name() const {
  return _has_bit(5);
}
inline void RseQueryStarInfo::clear_name() {
  name_ = 0;
  _clear_bit(5);
}
inline ::google::protobuf::int32 RseQueryStarInfo::name() const {
  return name_;
}
inline void RseQueryStarInfo::set_name(::google::protobuf::int32 value) {
  _set_bit(5);
  name_ = value;
}
