...
const ::google::protobuf::Descriptor* SpaceStar_descriptor_ = NULL;
const ::google::protobuf::internal::GeneratedMessageReflection*
  SpaceStar_reflection_ = NULL;
...
void protobuf_AssignDesc_RseQueryGalaxyWindow_2eproto() {
  ...
  static const int RseQueryGalaxyWindow_offsets_[5] = {
  ...
  static const int GalaxyWindow_offsets_[7] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(GalaxyWindow, spacestar_),
  ...
  GalaxyWindow_reflection_ =
    new ::google::protobuf::internal::GeneratedMessageReflection(
      ...
      ::google::protobuf::MessageFactory::generated_factory(),
      sizeof(GalaxyWindow));
  SpaceStar_descriptor_ = file->message_type(2);
  static const int SpaceStar_offsets_[1] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(SpaceStar, ret_),
  };
  SpaceStar_reflection_ =
    new ::google::protobuf::internal::GeneratedMessageReflection(
      SpaceStar_descriptor_,
      SpaceStar::default_instance_,
      SpaceStar_offsets_,
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(SpaceStar, _has_bits_[0]),
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(SpaceStar, _unknown_fields_),
      -1,
      ::google::protobuf::DescriptorPool::generated_pool(),
      ::google::protobuf::MessageFactory::generated_factory(),
      sizeof(SpaceStar));
...
void protobuf_RegisterTypes(const ::std::string&) {
  ...
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedMessage(
    SpaceStar_descriptor_, &SpaceStar::default_instance());
}
...
void protobuf_ShutdownFile_RseQueryGalaxyWindow_2eproto() {
  ...
  delete SpaceStar::default_instance_;
  delete SpaceStar_reflection_;
}
...
void protobuf_AddDesc_RseQueryGalaxyWindow_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\032RseQueryGalaxyWindow.proto\"\233\001\n\024RseQuer"
    "yGalaxyWindow\022#\n\014galaxyWindow\030\001 \003(\0132\r.Ga"
    "laxyWindow\022\024\n\014topLeftCoorX\030\002 \001(\005\022\024\n\014topL"
    "eftCoorY\030\003 \001(\005\022\030\n\020bottomRightCoorX\030\004 \001(\005"
    "\022\030\n\020bottomRightCoorY\030\005 \001(\005\"\224\001\n\014GalaxyWin"
    "dow\022\035\n\tSpaceStar\030\001 \003(\0132\n.SpaceStar\022\023\n\013pl"
    "anetsFree\030\002 \001(\005\022\027\n\017planetsOccupied\030\003 \001(\005"
    "\022\013\n\003sku\030\004 \001(\t\022\016\n\006starId\030\005 \001(\005\022\014\n\004type\030\006 "
    "\001(\005\022\014\n\004name\030\007 \001(\t\"\030\n\tSpaceStar\022\013\n\003ret\030\001 "
    "\001(\005", 363);
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 1: {
       ...
       parse_galaxyWindow:
        ...
        if (input->ExpectTag(10)) goto parse_galaxyWindow;
        if (input->ExpectTag(16)) goto parse_topLeftCoorX;
        break;
      }
      ...
      case 2: {
       ...
       parse_topLeftCoorX:
        DO_(::google::protobuf::internal::WireFormatLite::ReadInt32(
              input, &topleftcoorx_));
        _set_bit(1);
        if (input->ExpectTag(24)) goto parse_topLeftCoorY;
        break;
      }
      ...
      case 3: {
       ...
       parse_topLeftCoorY:
        DO_(::google::protobuf::internal::WireFormatLite::ReadInt32(
              input, &topleftcoory_));
        _set_bit(2);
        if (input->ExpectTag(32)) goto parse_bottomRightCoorX;
        break;
      }
      ...
      case 4: {
       ...
       parse_bottomRightCoorX:
        ...
        _set_bit(3);
        if (input->ExpectTag(40)) goto parse_bottomRightCoorY;
        break;
      }
...
void RseQueryGalaxyWindow::SerializeWithCachedSizes(
  ...
  for (int i = 0; i < this->galaxywindow_size(); i++) {
    ::google::protobuf::internal::WireFormatLite::WriteMessageNoVirtual(
      1, this->galaxywindow(i), output);
  }
  
  // optional int32 topLeftCoorX = 2;
  if (_has_bit(1)) {
    ::google::protobuf::internal::WireFormatLite::WriteInt32(2, this->topleftcoorx(), output);
  }
  
  // optional int32 topLeftCoorY = 3;
  if (_has_bit(2)) {
    ::google::protobuf::internal::WireFormatLite::WriteInt32(3, this->topleftcoory(), output);
  }
  
  // optional int32 bottomRightCoorX = 4;
  if (_has_bit(3)) {
    ::google::protobuf::internal::WireFormatLite::WriteInt32(4, this->bottomrightcoorx(), output);
  }
  
  // optional int32 bottomRightCoorY = 5;
  if (_has_bit(4)) {
    ::google::protobuf::internal::WireFormatLite::WriteInt32(5, this->bottomrightcoory(), output);
  }
  ...
  for (int i = 0; i < this->galaxywindow_size(); i++) {
    target = ::google::protobuf::internal::WireFormatLite::
      WriteMessageNoVirtualToArray(
        1, this->galaxywindow(i), target);
  }
  
  // optional int32 topLeftCoorX = 2;
  if (_has_bit(1)) {
    target = ::google::protobuf::internal::WireFormatLite::WriteInt32ToArray(2, this->topleftcoorx(), target);
  }
  
  // optional int32 topLeftCoorY = 3;
  if (_has_bit(2)) {
    target = ::google::protobuf::internal::WireFormatLite::WriteInt32ToArray(3, this->topleftcoory(), target);
  }
  
  // optional int32 bottomRightCoorX = 4;
  if (_has_bit(3)) {
    target = ::google::protobuf::internal::WireFormatLite::WriteInt32ToArray(4, this->bottomrightcoorx(), target);
  }
  
  // optional int32 bottomRightCoorY = 5;
  if (_has_bit(4)) {
    target = ::google::protobuf::internal::WireFormatLite::WriteInt32ToArray(5, this->bottomrightcoory(), target);
  }
...
const ::std::string GalaxyWindow::_default_name_;
#ifndef _MSC_VER
const int GalaxyWindow::kSpaceStarFieldNumber;
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 1: {
       ...
       parse_SpaceStar:
        DO_(::google::protobuf::internal::WireFormatLite::ReadMessageNoVirtual(
              input, add_spacestar()));
        if (input->ExpectTag(10)) goto parse_SpaceStar;
        if (input->ExpectTag(16)) goto parse_planetsFree;
        break;
      }
      ...
      case 2: {
       ...
       parse_planetsFree:
        DO_(::google::protobuf::internal::WireFormatLite::ReadInt32(
              input, &planetsfree_));
        _set_bit(1);
        if (input->ExpectTag(24)) goto parse_planetsOccupied;
        break;
      }
...
void GalaxyWindow::SerializeWithCachedSizes(
  ...
  // repeated .SpaceStar SpaceStar = 1;
  for (int i = 0; i < this->spacestar_size(); i++) {
    ::google::protobuf::internal::WireFormatLite::WriteMessageNoVirtual(
      1, this->spacestar(i), output);
  }
  
  // optional int32 planetsFree = 2;
  if (_has_bit(1)) {
    ::google::protobuf::internal::WireFormatLite::WriteInt32(2, this->planetsfree(), output);
  }
  
  // optional int32 planetsOccupied = 3;
  if (_has_bit(2)) {
    ::google::protobuf::internal::WireFormatLite::WriteInt32(3, this->planetsoccupied(), output);
  }
...
::google::protobuf::uint8* GalaxyWindow::SerializeWithCachedSizesToArray(
  ...
  for (int i = 0; i < this->spacestar_size(); i++) {
    target = ::google::protobuf::internal::WireFormatLite::
      WriteMessageNoVirtualToArray(
        1, this->spacestar(i), target);
  }
  
  // optional int32 planetsFree = 2;
  if (_has_bit(1)) {
    target = ::google::protobuf::internal::WireFormatLite::WriteInt32ToArray(2, this->planetsfree(), target);
  }
  
  // optional int32 planetsOccupied = 3;
  if (_has_bit(2)) {
    target = ::google::protobuf::internal::WireFormatLite::WriteInt32ToArray(3, this->planetsoccupied(), target);
  }
...
int GalaxyWindow::ByteSize() const {
  ...
  // repeated .SpaceStar SpaceStar = 1;
  total_size += 1 * this->spacestar_size();
  for (int i = 0; i < this->spacestar_size(); i++) {
    total_size +=
      ::google::protobuf::internal::WireFormatLite::MessageSizeNoVirtual(
        this->spacestar(i));
...
void GalaxyWindow::MergeFrom(const GalaxyWindow& from) {
  GOOGLE_CHECK_NE(&from, this);
  spacestar_.MergeFrom(from.spacestar_);
  if (from._has_bits_[1 / 32] & (0xffu << (1 % 32))) {
    if (from._has_bit(1)) {
...
void GalaxyWindow::Swap(GalaxyWindow* other) {
  if (other != this) {
    spacestar_.Swap(&other->spacestar_);
...
#ifndef _MSC_VER
const int SpaceStar::kRetFieldNumber;
#endif  // !_MSC_VER
...
void SpaceStar::InitAsDefaultInstance() {
}

SpaceStar::SpaceStar(const SpaceStar& from) {
  SharedCtor();
  MergeFrom(from);
}

void SpaceStar::SharedCtor() {
  _cached_size_ = 0;
  ret_ = 0;
  ::memset(_has_bits_, 0, sizeof(_has_bits_));
}
...
void SpaceStar::SharedDtor() {
  if (this != default_instance_) {
  }
}

const ::google::protobuf::Descriptor* SpaceStar::descriptor() {
  protobuf_AssignDescriptorsOnce();
  return SpaceStar_descriptor_;
}

const SpaceStar& SpaceStar::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_RseQueryGalaxyWindow_2eproto();  return *default_instance_;
}

SpaceStar* SpaceStar::default_instance_ = NULL;

SpaceStar* SpaceStar::New() const {
  return new SpaceStar;
}

void SpaceStar::Clear() {
...
bool SpaceStar::MergePartialFromCodedStream(
    ::google::protobuf::io::CodedInputStream* input) {
#define DO_(EXPRESSION) if (!(EXPRESSION)) return false
  ::google::protobuf::uint32 tag;
  while ((tag = input->ReadTag()) != 0) {
...
void SpaceStar::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  ::google::protobuf::uint8* raw_buffer = output->GetDirectBufferForNBytesAndAdvance(_cached_size_);
  if (raw_buffer != NULL) {
    SpaceStar::SerializeWithCachedSizesToArray(raw_buffer);
    return;
  }
...
::google::protobuf::uint8* SpaceStar::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // optional int32 ret = 1;
  if (_has_bit(0)) {
...
void SpaceStar::MergeFrom(const ::google::protobuf::Message& from) {
  GOOGLE_CHECK_NE(&from, this);
  const SpaceStar* source =
    ::google::protobuf::internal::dynamic_cast_if_available<const SpaceStar*>(
      &from);
  if (source == NULL) {
    ::google::protobuf::internal::ReflectionOps::Merge(from, this);
  } else {
...
void SpaceStar::MergeFrom(const SpaceStar& from) {
  GOOGLE_CHECK_NE(&from, this);
...
void SpaceStar::CopyFrom(const ::google::protobuf::Message& from) {
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

void SpaceStar::CopyFrom(const SpaceStar& from) {
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool SpaceStar::IsInitialized() const {
  
  return true;
}

void SpaceStar::Swap(SpaceStar* other) {
  if (other != this) {
...
::google::protobuf::Metadata SpaceStar::GetMetadata() const {
  protobuf_AssignDescriptorsOnce();
  ::google::protobuf::Metadata metadata;
  metadata.descriptor = SpaceStar_descriptor_;
  metadata.reflection = SpaceStar_reflection_;
  return metadata;
}
