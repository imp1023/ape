...
// optional int32 ret = 1;
inline bool RceFinished::has_ret() const {
  return _has_bit(0);
}
inline void RceFinished::clear_ret() {
  ret_ = 0;
  _clear_bit(0);
}
inline ::google::protobuf::int32 RceFinished::ret() const {
  return ret_;
}
inline void RceFinished::set_ret(::google::protobuf::int32 value) {
  _set_bit(0);
  ret_ = value;
}
